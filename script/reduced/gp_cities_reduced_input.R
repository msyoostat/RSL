...
library(plgp)
set.seed(1)
load("/Users/myungsooyoo/Desktop/My_stuff/research/emulator/AML_project_important-20230821T155429Z-001/AML_project_important/regionalization/regional_cities_train_test_val.RData")
...
train_data_lithk_region_mean_x<-read.table("/Users/myungsooyoo/Desktop/My_stuff/research/emulator/python/darwin/final/previous/previous_final/train_data_lithk_region_mean_x.txt", header = FALSE, sep = ",", dec = ".")
test_data_lithk_region_mean_x<-read.table("/Users/myungsooyoo/Desktop/My_stuff/research/emulator/python/darwin/final/previous/previous_final/test_data_lithk_region_mean_x.txt", header = FALSE, sep = ",", dec = ".")
val_data_lithk_region_mean_x<-read.table("/Users/myungsooyoo/Desktop/My_stuff/research/emulator/python/darwin/final/previous/previous_final/val_data_lithk_region_mean_x.txt", header = FALSE, sep = ",", dec = ".")
