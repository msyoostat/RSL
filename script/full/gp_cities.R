...
train_data_x<-read.table("train_data_x.txt", header = FALSE, sep = ",", dec = ",")
test_data_x<-read.table("test_data_x.txt", header = FALSE, sep = ",", dec = ",")
val_data_x<-read.table("val_data_x.txt", header = FALSE, sep = ",", dec = ",")
