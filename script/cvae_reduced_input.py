...
for i in range(0,ensemble_N,1):
    Z= torch.randn(val_data_lithk_region_mean_x.shape[0],z_dim)
...
for i in range(0,ensemble_N,1):
    Z= torch.randn(test_data_lithk_region_mean_x.shape[0],z_dim)
...
import pickle
result = {'prediictions_ensemble_val_mean':prediictions_ensemble_val_mean,'costval_training':costval_training, 'costval_validation':costval_validation, 'S_square_val':S_square_val, 'intercept_val':intercept_val,'slope_val':slope_val,
...
with open('cvae_reduced_input.pickle', 'wb') as f:
